<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="UpdatePremium.aspx.cs" Inherits="WebSwift.Premium.UpdatePremium" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <hr />
        ...
        <asp:Button ID="Button1" runat="server" Text="Up Date" 
                            CausesValidation="true" onclick="btnPremiumUpDate_Click" />
        <br />
        <br />
        <br />
